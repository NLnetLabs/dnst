...
copyright = f'2024–{year}, NLnet Labs'
author = 'NLnet Labs'
...
htmlhelp_basename = 'dnst-user-manual'
...
latex_documents = [
    (master_doc, 'dnst-user-manual.tex', 'dnst User Manual',
     'NLnet Labs', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'dnst-user-manual', 'dnst User Manual',
     author, 'dnst-user-manual', 'One line description of project.',
     'Miscellaneous'),
]
